...
rule
  ...
  dictionary: dictionary_in dictionary_contents dictionary_out { result = Mork::Dictionary.new(content: val[1].flatten.compact) }
  ...
  meta: meta_in meta_alias_in meta_alias meta_alias_out meta_out { result = Mork::MetaAlias.new(raw: val[2]) }

  group: group_in group_content group_out { result = Mork::Group.new(content: val[1]) }
  ...
  meta_table: meta_table_in meta_table_content meta_table_out { result = Mork::MetaTable.new(raw: val[1]) }
  meta_table_content: 
  ...
  alias: alias_in alias_key alias_value alias_out { result = Mork::Alias.new(key: val[1], value: val[2]) }
